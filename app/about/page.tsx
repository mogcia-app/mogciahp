              ...
              <div className="max-w-7xl mx-auto">
                <div className="bg-white p-6 sm:p-8 group relative">
                  ...
                  <div className="text-center mb-12 sm:mb-16">
                    <AnimatedSection animation="fadeInUp" delay={200}>
                      ...
                      <p className="text-base sm:text-lg text-gray-500 font-light tracking-wide max-w-4xl mx-auto">
                        AIとデジタル技術で、お客様のビジネスの未来を創造する私たちの使命・ビジョン・価値観をご紹介します
                      </p>
                    </AnimatedSection>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
                    ...
                    <AnimatedSection animation="fadeInUp" delay={400}>
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-2 tracking-wide">Mission</h3>
                        <div className="text-sm text-gray-500 font-light mb-4 tracking-wide">ミッション</div>
                        <p className="text-sm text-gray-600 font-light leading-relaxed mb-4">
                          AI・デジタル技術で企業の未来を創造する
                        </p>
                        <div className="space-y-1 text-xs text-gray-500">
                          <div>• 2023年11月設立時の原点</div>
                          <div>• すべての事業の根幹となる理念</div>
                          <div>• 設立から現在まで一貫した使命</div>
                        </div>
                      </div>
                    </AnimatedSection>
                    ...
                    <AnimatedSection animation="fadeInUp" delay={600}>
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-2 tracking-wide">Vision</h3>
                        <div className="text-sm text-gray-500 font-light mb-4 tracking-wide">ビジョン</div>
                        <p className="text-sm text-gray-600 font-light leading-relaxed mb-4">
                          AI×デジタルで、すべての企業の成長を加速する
                        </p>
                        <div className="space-y-1 text-xs text-gray-500">
                          <div>• 全国の中小企業のデジタル課題解決</div>
                          <div>• 実践経験に基づくソリューション提供</div>
                          <div>• MOGCIA Coffeeでの実践から得た知見</div>
                        </div>
                      </div>
                    </AnimatedSection>
                    ...
                    <AnimatedSection animation="fadeInUp" delay={800}>
                      <div className="text-center">
                        <h3 className="text-lg font-medium text-gray-900 mb-2 tracking-wide">Values</h3>
                  ...
                  <div className="mt-12 sm:mt-16">
                    <AnimatedSection animation="fadeInUp" delay={800}>
                      <div className="text-center mb-8">
                        <h3 className="text-2xl sm:text-3xl font-thin text-gray-900 mb-4 tracking-wider">MOGCIAの価値観</h3>
                        <div className="w-24 h-px bg-gray-300 mx-auto mb-4"></div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                      {[
                        ...
                        <AnimatedSection key={value.letter} animation="fadeInUp" delay={1000 + (index * 100)}>
                          <div className="text-center group">
                            ...
                            <h4 className="text-base font-medium text-gray-900 mb-2 tracking-wide group-hover:text-gray-700 transition-colors duration-300">
                              {value.title}
                            </h4>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
                    <AnimatedSection animation="fadeInUp" delay={400}>
                      <div className="space-y-6">
                        <div className="text-center">
                          <h3 className="text-xl font-medium text-gray-900 mb-2 tracking-wide">株式会社MOGCIA</h3>
                          <p className="text-sm text-gray-500 font-light">MOGCIA Inc.</p>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-900">設立</p>
                              <p className="text-xs text-gray-600 font-light">2023年11月</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-gray-400 rounded-full mr-3 mt-2"></div>
                            <div>
                              <p className="text-sm font-medium text-gray-900">所在地</p>
                              <p className="text-xs text-gray-600 font-light">福岡県福岡市中央区天神4-6-28 いちご天神ノースビル７階</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-600 font-light">092-517-9804</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <AnimatedSection animation="fadeInUp" delay={600}>
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-lg font-medium text-gray-900 mb-4 tracking-wide">事業内容</h4>
                          <div className="space-y-2">
                            <div className="flex items-start">
                              <div className="w-1.5 h-1.5 bg-gray-400 rounded-full mr-3 mt-2"></div>
                              <p className="text-sm text-gray-600 font-light">AI・DXソリューションの企画・開発</p>
                            </div>
                            <div className="flex items-start">
                              <div className="w-1.5 h-1.5 bg-gray-400 rounded-full mr-3 mt-2"></div>
                              <p className="text-sm text-gray-600 font-light">デジタルマーケティング支援</p>
                            </div>
                            <div className="flex items-start">
                              <div className="w-1.5 h-1.5 bg-gray-400 rounded-full mr-3 mt-2"></div>
                              <p className="text-sm text-gray-600 font-light">Webサイト・システム開発</p>
                            </div>
                            <div className="flex items-start">
                              <div className="w-1.5 h-1.5 bg-gray-400 rounded-full mr-3 mt-2"></div>
                              <p className="text-sm text-gray-600 font-light">OEM企画・製造サポート</p>
                            </div>
                          </div>
                        </div>

                        <div>
                          <h4 className="text-lg font-medium text-gray-900 mb-4 tracking-wide">私たちの強み</h4>
                ...
                <div className="bg-white border border-gray-200 p-6 sm:p-8 hover:shadow-lg transition-all duration-300 group relative">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm sm:text-base text-gray-500 font-light tracking-wide mb-8 max-w-3xl mx-auto">
                      AI・デジタル技術に関するご相談やご質問がございましたら、お気軽にお問い合わせください。専門スタッフがサポートいたします。
                    </p>
                    <a
                      href="/contact"
